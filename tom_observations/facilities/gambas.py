...
class LCOObservationForm(GenericObservationForm):
    ...
    filter1 = forms.ChoiceField(choices=_filter_choices)
    filter2 = forms.ChoiceField(choices=_filter_choices)
    filter3 = forms.ChoiceField(choices=_filter_choices)
    instrument_name = forms.ChoiceField(choices=_instrument_choices)
    exposure_count = forms.IntegerField(min_value=1)
    exposure_time1 = forms.FloatField(min_value=0.1)
